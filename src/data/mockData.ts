...
export const INITIAL_SALARY_RULES: SalaryRuleConfig = {
  ...
  authorizedWifiNetworks: [
    {
      ssid: "DMJ-Corporate-5G",
      bssid: "74:83:C2:AA:01:9F",
      locationName: "PT Dwi Martha Jaya - Kantor Pusat & Workshop",
      description: "Jaringan Resmi High-Speed 5G PT Dwi Martha Jaya"
    },
    {
      ssid: "DMJ-SiteOffice-Manyar",
      bssid: "18:E8:29:FE:44:12",
      locationName: "Site Office & Workshop Manyar DMJ",
      description: "Jaringan Lapangan Proyek Konstruksi & Fabrikasi DMJ"
    },
    {
      ssid: "DMJ-Mining-Pomalaa",
      bssid: "00:25:9C:12:88:BB",
      locationName: "Field Camp & Basecamp Mining Pomalaa DMJ",
      description: "Jaringan Khusus Service Alat Berat Tambang DMJ"
    }
  ],
  authorizedIpNetworks: [
    {
      ipOrSubnet: "103.31.205.218",
      label: "Gateway Utama DMJ (Biznet Fiber Dedicated)",
      isp: "PT Biznet Gio Nusantara",
      isRegisteredOffice: true
    },
    {
      ipOrSubnet: "103.31.205.0/24",
      label: "Subnet Enterprise Kantor Pusat & Workshop DMJ",
      isp: "PT Biznet Gio Nusantara",
      isRegisteredOffice: true
    },
    {
      ipOrSubnet: "180.252.0.0/16",
      label: "Telkom Astinet Dedicated Site Manyar DMJ",
      isp: "PT Telkom Indonesia",
      isRegisteredOffice: true
    },
    {
      ipOrSubnet: "192.168.10.0/24",
      label: "Local Intranet Subnet DMJ Workshop & Engineering",
      isp: "LAN DHCP Subnet",
      isRegisteredOffice: true
    }
  ],
  officeGeofence: {
    name: "PT Dwi Martha Jaya - Kantor Pusat & Workshop Terpadu",
    lat: -7.118942,
    lng: 112.584319,
    radiusMeters: 350,
    address: "Kawasan Industri Terpadu, Jl. Raya Utama DMJ Blok A1-A4, Jawa Timur"
  }
};
...
export const INITIAL_EMPLOYEES: Employee[] = [
  ...
  },
  {
    ...
    email: "budi.santoso@dwimarthajaya.co.id",
    ...
    employmentType: "TETAP",
    joinDate: "2021-03-15",
    assignedProjectId: "DMJ-MINING-02",
    baseSalary: 15000000,
  ...
  },
  {
    ...
    email: "siti.rahmawati@dwimarthajaya.co.id",
    ...
    employmentType: "TETAP",
    joinDate: "2022-08-01",
    assignedProjectId: "DMJ-CIVIL-03",
    baseSalary: 12500000,
  ...
  },
  {
    ...
    email: "hendra.wijaya@dwimarthajaya.co.id",
  ...
  },
  {
    ...
    email: "dian.lestari@dwimarthajaya.co.id",
    ...
    employmentType: "TETAP",
    joinDate: "2023-09-01",
    assignedProjectId: "DMJ-PLANT-04",
    baseSalary: 8500000,
...
export const INITIAL_PROJECTS: Project[] = [
  {
    id: "DMJ-ENG-01",
    code: "DMJ-ENG-01",
    name: "Konstruksi Pabrik & Instalasi Mekanikal Smelter DMJ",
    client: "PT Dwi Martha Jaya (Divisi Engineering)",
  ...
  },
  {
    ...
    client: "PT Dwi Martha Jaya (Divisi Mining Service)",
  ...
  },
  {
    id: "DMJ-CIVIL-03",
    code: "DMJ-CIVIL-03",
    name: "Pembangunan Pergudangan & Workshop Logistik DMJ",
    client: "PT Dwi Martha Jaya (Divisi Infrastruktur)",
    location: "Kawasan Workshop Utama DMJ, Jawa Timur",
    status: "ACTIVE",
  ...
  },
  {
    id: "DMJ-PLANT-04",
    code: "DMJ-PLANT-04",
    name: "Fabrikasi Struktur Baja & Piping System Pabrik DMJ",
    client: "PT Dwi Martha Jaya (Divisi Industrial Plant)",
    location: "Workshop Fabrikasi Pusat DMJ",
    status: "ACTIVE",
...
export const INITIAL_ATTENDANCE: AttendanceRecord[] = [
  {
    id: "ATT-20260908-01",
    employeeId: "EMP-001",
    employeeName: "Galih Primananda, S.E.",
    employeeNik: "DMJ-2024-001",
    department: "Engineering & Digital Transformation",
    date: "2026-09-08",
    ...
    location: {
      ...
      lng: 112.584402,
      accuracy: 5.8,
      address: "Workshop Utama PT Dwi Martha Jaya, Blok A1-A4",
      inGeofence: true,
      distanceMeters: 22
    },
    wifi: {
    ...
    note: "Dandori alat ukur & calibrator mesin CNC Fabrikasi DMJ Line A",
    isLate: false,
    lateMinutes: 0,
  ...
  },
  {
    ...
    location: {
      ...
      lng: 112.584110,
      accuracy: 8.5,
      address: "Main Gate Pos 1, PT Dwi Martha Jaya",
      inGeofence: true,
      distanceMeters: 38
    },
    wifi: {
    ...
    isLate: true,
    lateMinutes: 22,
    lateReason: "Kemacetan parah di jembatan akses tol Manyar dan screening APD di gate 1 DMJ",
  ...
  },
  {
    ...
    lateMinutes: 0,
    dinasLuarDetails: {
      destination: "Site Pomalaa DMJ, Kolaka",
      clientName: "PT Dwi Martha Jaya (Mining Service)",
      projectCode: "DMJ-MINING-02",
...
export const INITIAL_APPROVALS: ApprovalItem[] = [
  {
    ...
    description: "Keterlambatan presensi pada tanggal 8 September 2026 akibat macet di akses tol dan antrean gate 1 PT Dwi Martha Jaya. Mohon pembebasan sanksi potongan penalti keterlambatan.",
  ...
  },
  {
    ...
    employeeNik: "DMJ-2024-089",
    department: "Mechanical & Field Service",
    title: "Persetujuan Dinas Luar Mendadak - Site Pomalaa DMJ",
  ...
  },
  {
    ...
    description: "Keterlambatan masuk akibat inspeksi rute logistik material baja menuju workshop DMJ Manyar.",
    startDate: "2026-08-14",
    lateMinutes: 35,
    status: "REJECTED",
    submittedAt: "2026-08-14 09:10:00",
    reviewedBy: "Direksi Operasional DMJ",
...
export const INITIAL_REIMBURSEMENTS: ReimbursementClaim[] = [
  {
    ...
    title: "BBM & Tol Mobil Operasional Inspeksi Smelter DMJ",
    description: "Pembelian Pertamax & e-Toll untuk monitoring instalasi mekanikal di Manyar Gresik.",
    amount: 450000,
    date: "2026-09-04",
    projectId: "DMJ-ENG-01",
    projectName: "Konstruksi Pabrik & Instalasi Mekanikal Smelter DMJ",
    status: "APPROVED",
    submittedAt: "2026-09-04 17:30:00",
    reviewedBy: "Finance DMJ Lead",
  ...
  },
  {
    ...
    rejectReason: "DITOLAK: Struk kuitansi pembayaran buram, tidak ada cap stempel resto/katering rekanan DMJ, dan melebihi pagu konsumsi harian Rp 50.000/orang."
  },
  {
    id: "REIMB-2026-003",
    employeeId: "EMP-002",
  ...
  },
  {
    ...
    description: "Pengadaan kertas sertifikat uji tarik dan dokumen safety QA/QC DMJ.",
    amount: 380000,
    date: "2026-09-02",
    projectId: "DMJ-PLANT-04",
    projectName: "Fabrikasi Struktur Baja & Piping System Pabrik DMJ",
    status: "DISBURSED",
